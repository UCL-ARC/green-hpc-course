...
The PUE of the facility that hosts Young in Torrington Place ranges between 1.5-1.6 (1.5 is the design PUE value for Torrington Place when fully loaded, but in practice it is somewhere around 1.6 and possibly higher in summer). PUE value also depends on the location of the facility. The ARCHER2 facility has a lower PUE values as it is situated in Scotland where air temperatures are cool; hence it benefits from free cooling for a large proportion of the year.
